...
export class OrdersListController {
  ...
  private getMockOrders(sourceFilter?: string): Record<string, unknown>[] {
    ...
    const orders = [
      ...
      { id: 'ord-016', order_number: '26-00016', total_price: 1350, status: 'DELIVERED', channel: 'manual', source: 'MANUAL', notes: 'Dükkandan elden sipariş', customer_note: '', created_at: new Date(now - 20000000).toISOString(), customer_name: 'Osman Yıldırım', customer_phone: '05341234567', customer_city: 'Afyonkarahisar', customer_address: 'Afyonkarahisar, Çarşı', customer_company: '', customer_birthday: '', customer_identity: '', items: [{ product_name: 'Dana Parmak Sucuk', quantity: 1, unit: 'KG', unit_price: 890 }, { product_name: 'Haşhaş Ezmesi', quantity: 4, unit: 'KG', unit_price: 115 }] },
    ];
