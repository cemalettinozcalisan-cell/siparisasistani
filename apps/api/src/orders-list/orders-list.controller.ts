...
export class OrdersListController {
  ...
  private getMockOrders(sourceFilter?: string): Record<string, unknown>[] {
    ...
    const orders = [
      ...
      { id: 'ord-003', order_number: '26-00003', total_price: 28500, status: 'APPROVED', channel: 'wholesale', source: 'WHOLESALE', notes: 'Toptan sipariş', customer_note: '30 koli', created_at: new Date(now - 10800000).toISOString(), customer_name: 'Fatma Şahin', customer_phone: '05449876543', customer_address: 'Ankara, Çankaya', items: [{ product_name: 'Köy Yumurtası', quantity: 30, unit: 'KOLİ', unit_price: 650 }, { product_name: 'Bükme (Patatesli)', quantity: 15, unit: 'TEPİ', unit_price: 600 }] },
