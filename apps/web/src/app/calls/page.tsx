...
const CHANNEL_CONFIG = [
  ...
  { key: 'sms', type: 'sms', label: 'SMS', icon: MessageSquare, gradient: 'from-orange-400 to-orange-600', borderLeft: 'border-l-orange-500', shadow: 'shadow-orange-400/20', badgeBg: 'bg-orange-500' },
